...
public class DialogFragForEvent extends android.support.v4.app.DialogFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        timeHour=(EditText) rootView.findViewById(R.id.setTimeHour);
        timeMin=(EditText) rootView.findViewById(R.id.setTimeMin);
        timeFormat=(Spinner) rootView.findViewById(R.id.setTimeFormat);
