...
import com.company.appbrkr.tourbuddy.pojo.Example;
import com.company.appbrkr.tourbuddy.service.RetrofitMaps;
...
public class NearbyFragment extends Fragment implements OnMapReadyCallback,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //permission
        if (checkPermission(Manifest.permission.ACCESS_FINE_LOCATION,getApplicationContext(),getActivity())) {
            fetchLocationData();
        }
        else
        {
            requestPermission(Manifest.permission.ACCESS_FINE_LOCATION,PERMISSION_REQUEST_CODE_LOCATION,getApplicationContext(),getActivity());
        }
            ...
            public void onResponse(Response<Example> response, Retrofit retrofit) {
                ...
                try {
                    ...
                    for (int i = 0; i < response.body().getResults().size(); i++) {
                        ...
                        mMap.animateCamera(CameraUpdateFactory.zoomTo(A));
                    }
                } catch (Exception e) {
